...
resultats = pd.DataFrame({'erreur entraînement': [score_train], 'erreur test': [score_test], 'test f1': [f1]})
resultats.to_csv('resultats/kmeans.csv', index=False)